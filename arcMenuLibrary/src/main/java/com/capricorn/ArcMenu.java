...
public class ArcMenu extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        mArcLayout = (ArcLayout) findViewById(R.id.item_layout);                                //Framelayout + ImageView

        final ViewGroup controlLayout = (ViewGroup) findViewById(R.id.control_layout);          //Framelayout
